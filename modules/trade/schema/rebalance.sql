CREATE TABLE IF NOT EXISTS t_rebalance_runs (
    ...
    c_idempotency_key TEXT NOT NULL,
    c_market_snapshot_id TEXT NOT NULL,
    c_position_snapshot_id TEXT NOT NULL,
    ...
    c_residual TEXT NOT NULL DEFAULT '{}',
    c_ctime DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    c_mtime DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (c_space_id, c_run_id),
    UNIQUE (c_space_id, c_idempotency_key)
);
...
CREATE TABLE IF NOT EXISTS t_rebalance_targets (
    ...
    c_target_quantity TEXT NOT NULL,
    UNIQUE (c_space_id, c_run_id, c_symbol)
);
...
CREATE TABLE IF NOT EXISTS t_rebalance_legs (
    ...
    c_plan_id TEXT NOT NULL DEFAULT '',
    c_status TEXT NOT NULL,
    UNIQUE (c_space_id, c_leg_id),
    UNIQUE (c_space_id, c_run_id, c_sequence)
);
