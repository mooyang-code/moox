...
CREATE TABLE IF NOT EXISTS t_rebalance_legs (
 ...
 c_symbol TEXT NOT NULL, c_market_type TEXT NOT NULL, c_base_asset TEXT NOT NULL, c_quote_asset TEXT NOT NULL, c_side TEXT NOT NULL, c_action TEXT NOT NULL,
 c_quantity TEXT NOT NULL, c_price TEXT NOT NULL, c_reduce_only INTEGER NOT NULL DEFAULT 0,
