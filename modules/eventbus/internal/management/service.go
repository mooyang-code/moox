// Package management exposes a read-only EventBus status surface.
package management
...
// StateSource is the read-only subset of JetStream required by management.
// Keeping the management plane on this narrow interface allows unit tests and
