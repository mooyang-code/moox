...
func (p *scanSourceProxy) MergeTimeSeriesRows(context.Context, *pb.MergeTimeSeriesRowsReq, ...client.Option) (*pb.MergeTimeSeriesRowsRsp, error) {
	return nil, errors.New("not used")
}

func (p *scanSourceProxy) ReadTimeSeriesRows(context.Context, *pb.ReadTimeSeriesRowsReq, ...client.Option) (*pb.ReadTimeSeriesRowsRsp, error) {
	p.readTimeSeriesCalled = true
	return nil, errors.New("public read must not be used for internal scan")
}

func (p *scanSourceProxy) DeleteTimeSeriesRows(context.Context, *pb.DeleteTimeSeriesRowsReq, ...client.Option) (*pb.DeleteTimeSeriesRowsRsp, error) {
	return nil, errors.New("not used")
}

func (p *scanSourceProxy) MergeRecordRows(context.Context, *pb.MergeRecordRowsReq, ...client.Option) (*pb.MergeRecordRowsRsp, error) {
	return nil, errors.New("not used")
}

func (p *scanSourceProxy) ReadRecordRows(context.Context, *pb.ReadRecordRowsReq, ...client.Option) (*pb.ReadRecordRowsRsp, error) {
	p.readRecordCalled = true
	return nil, errors.New("public read must not be used for internal scan")
}

func (p *scanSourceProxy) ScanTimeSeriesRows(_ context.Context, req *pb.ScanTimeSeriesRowsReq, _ ...client.Option) (*pb.ScanTimeSeriesRowsRsp, error) {
...
func (p *scanSourceProxy) ScanRecordRows(_ context.Context, req *pb.ScanRecordRowsReq, _ ...client.Option) (*pb.ScanRecordRowsRsp, error) {
	p.recordScan = req
