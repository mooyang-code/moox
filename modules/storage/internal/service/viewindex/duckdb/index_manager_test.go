...
func TestIndexManagerKeepsViewSlotsInIndependentFiles(t *testing.T) {
	...
	if err := manager.Write(ctx, a, viewindex.BatchWrite{TimeSeriesRows: []*pb.TimeSeriesRow{
...
func TestIndexManagerReopensExistingSlot(t *testing.T) {
	...
	if err := manager.Write(ctx, id, viewindex.BatchWrite{TimeSeriesRows: []*pb.TimeSeriesRow{
