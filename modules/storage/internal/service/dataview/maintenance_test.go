...
func (e *maintenanceEngine) Write(_ context.Context, indexID string, batch viewindex.BatchWrite) error {
	if e.onWrite != nil {
		e.onWrite()
	}
	keys := e.keys[indexID]
...
func (e *maintenanceEngine) Apply(ctx context.Context, indexID string, batch viewindex.ViewIndexApplyBatch) error {
	legacy := viewindex.BatchWrite{ViewVersion: batch.ViewVersion, SchemaHash: batch.ViewSchemaHash}
