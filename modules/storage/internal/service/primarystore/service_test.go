...
func TestPrimaryExactTimeSeriesReadOmitsMissingRows(t *testing.T) {
	...
	keys := []*pb.TimeSeriesKey{
		{SpaceId: "space", DatasetId: "dataset", SubjectId: "subject", Freq: "1H", DataTime: "2026-07-29T16:00:00Z"},
		{SpaceId: "space", DatasetId: "dataset", SubjectId: "subject", Freq: "1H", DataTime: "2026-07-29T15:00:00Z"},
	}
