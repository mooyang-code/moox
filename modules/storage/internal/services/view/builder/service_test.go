...
func TestServiceTimeSeriesHandlerReturnsWriterError(t *testing.T) {
	...
	service := newStartedViewBuilderTestService(t, ctx, viewBuilderTestOptions{
		timeSeriesRows: []*pb.TimeSeriesRow{
			{
				Key:     &pb.TimeSeriesKey{SpaceId: "crypto", DatasetId: "kline", SubjectId: "APT-USDT", Freq: "1m", DataTime: "2026-06-15T00:00:00Z"},
				Columns: []*pb.ColumnValue{doubleColumn("close", 8.1)},
...
func TestServiceStartValidatesRequiredDependencies(t *testing.T) {
	base := func() Options {
		return Options{
			Events:   eventbus.NewMemoryBus(),
			Reader:   &fakeViewBuilderReader{},
			Metadata: &fakeViewBuilderMetadata{},
			Views:    &capturingTimeSeriesWriter{},
			Search:   &capturingRecordIndexer{},
		}
	}
	tests := []struct {
		...
		{name: "metadata client", mut: func(opts *Options) { opts.Metadata = nil }},
...
type viewBuilderTestOptions struct {
	timeSeriesRows []*pb.TimeSeriesRow
	recordRows     []*pb.RecordRow
	viewsByDataset map[string][]*pb.View
	columnsByView  map[string][]*pb.ViewColumn
...
func newStartedViewBuilderTestService(t *testing.T, ctx context.Context, opts viewBuilderTestOptions) *Service {
	t.Helper()
	service := NewService(Options{
		Events: eventbus.NewMemoryBus(),
		Reader: &fakeViewBuilderReader{
...
type fakeViewBuilderReader struct {
	timeSeriesRows []*pb.TimeSeriesRow
	recordRows     []*pb.RecordRow
}

func (r *fakeViewBuilderReader) ReadTimeSeriesRows(context.Context, *pb.ReadTimeSeriesRowsReq) (*pb.ReadTimeSeriesRowsRsp, error) {
...
func (r *fakeViewBuilderReader) ReadRecordRows(context.Context, *pb.ReadRecordRowsReq) (*pb.ReadRecordRowsRsp, error) {
...
type fakeViewBuilderMetadata struct {
	metadata.Store
	viewsByDataset map[string][]*pb.View
	columnsByView  map[string][]*pb.ViewColumn
}

func (m *fakeViewBuilderMetadata) ListViewsByDataset(_ context.Context, spaceID string, datasetID string) ([]*pb.View, error) {
...
func (m *fakeViewBuilderMetadata) ListViewColumns(_ context.Context, spaceID string, viewID string, _ *pb.Page) ([]*pb.ViewColumn, *pb.PageResult, error) {
...
func (m *fakeViewBuilderMetadata) UpsertView(_ context.Context, item *pb.View) (*pb.View, error) {
