...
func ToStorageRows(in *sharedpb.DatasetRowsUpserted) (*localpb.RowsUpserted, error) {
	...
	rowData := &sharedpb.DatasetRowsUpserted{SpaceId: in.GetSpaceId(), DatasetId: in.GetDatasetId(), Rows: in.GetRows(), WriteSource: in.GetWriteSource(), WriteKind: in.GetWriteKind()}
