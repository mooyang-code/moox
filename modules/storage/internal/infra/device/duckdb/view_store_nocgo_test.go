...
func TestViewStoreNoCGOMethodsReturnCGORequiredError(t *testing.T) {
	...
	require.ErrorIs(t, store.Write(ctx, "idx-1", viewindex.ViewIndexBatch{}), errDuckDBRequiresCGO)
...
func TestIndexManagerNoCGOMethodsReturnCGORequiredError(t *testing.T) {
	...
	require.ErrorIs(t, mgr.Write(ctx, "idx-1", viewindex.ViewIndexBatch{}), errDuckDBRequiresCGO)
