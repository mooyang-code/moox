...
replace (
	...
	github.com/mooyang-code/moox/modules/storage/proto/genv2 => ./proto/genv2
)
...
require (
	...
	github.com/mooyang-code/go-commlib/open-wuji v0.0.1
	github.com/mooyang-code/go-commlib/tinyfunc v0.0.5
