...
type CollectorTaskRuleHandler struct {
	service collectmgr.TaskRuleService
}

// NewCollectorTaskRuleHandler 创建采集任务规则处理器
func NewCollectorTaskRuleHandler(service collectmgr.TaskRuleService) *CollectorTaskRuleHandler {
