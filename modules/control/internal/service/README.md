...
```bash
cd src/github.com/mooyang-code/moox/modules/control
go mod tidy
```
...
import (
    "github.com/mooyang-code/moox/modules/control/internal/service/auth"
    "github.com/mooyang-code/moox/modules/control/internal/service/auth/config"
    "github.com/mooyang-code/moox/modules/control/internal/service/admin"
    adminconfig "github.com/mooyang-code/moox/modules/control/internal/service/admin/config"
)
