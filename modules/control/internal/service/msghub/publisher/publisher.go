...
import (
	"fmt"
	"github.com/mooyang-code/moox/modules/control/internal/service/msghub/publisher/registry"
	"github.com/mooyang-code/moox/modules/control/internal/service/msghub/types"

	// 导入NATS实现以触发init注册
	_ "github.com/mooyang-code/moox/modules/control/internal/service/msghub/publisher/nats"
)

// NewPublisher 创建发布器
func NewPublisher(publisherType types.PublisherType, opts types.PublisherOptions) (types.Publisher, error) {
