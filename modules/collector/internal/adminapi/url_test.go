...
func TestURLUsesAPIServicePath(t *testing.T) {
	got := URL("127.0.0.1", 11000, "cloudnode", "ReportHeartbeat")
	want := "http://127.0.0.1:11000/api/service/cloudnode/ReportHeartbeat"
	if got != want {
...
func TestNewSignedRequestSetsAuthHeader(t *testing.T) {
	...
	req, err := NewSignedRequest(
		"POST",
		"http://127.0.0.1:11000/api/service/collectmgr/ReportTaskStatus",
		body,
