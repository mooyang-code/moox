...
func NewClient(getter core.Getter) *Client {
	return &Client{Client: core.NewClient(core.Config{ProviderID: "eastmoney", SourceID: "stock_us_http", MarketID: "stock_us", InstrumentType: "equity", Frequencies: []string{"1m", "5m", "15m", "30m", "60m", "1d", "1w", "1M"}, HistoryStart: "2000-01-01", SecID: SecID}, getter)}
}
