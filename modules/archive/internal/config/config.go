	...
	return &Config{
		Archive: ArchiveConfig{
			...
			Sources: map[string]SourceConfig{
				...
				"stock_hk": {Datasets: []string{"stock_hk_kline"}},
				"stock_us": {Datasets: []string{"stock_us_kline"}},
				"crypto":   {Datasets: []string{"binance_spot_kline_1m", "binance_swap_kline_1m", "spot_kline_1h", "perpetual_kline_1h"}},
			},
