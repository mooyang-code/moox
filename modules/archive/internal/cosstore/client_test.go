...
func TestObjectKey(t *testing.T) {
	path := "/archive/crypto/dataset_spot_kline_1h/1h/BTC-USDT/series_tag=venue%3Abinance/crypto__dataset_spot_kline_1h__BTC-USDT__1h__series_tag=venue%3Abinance__202606.parquet"
	key, err := ObjectKey("/archive", "moox/archive", path)
	if err != nil || key != "moox/archive/crypto/dataset_spot_kline_1h/1h/BTC-USDT/series_tag=venue%3Abinance/crypto__dataset_spot_kline_1h__BTC-USDT__1h__series_tag=venue%3Abinance__202606.parquet" {
