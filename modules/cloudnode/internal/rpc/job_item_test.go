...
func (s *orderedStore) CreatePending(context.Context, *pb.JobItem) (*jobstate.CreateResult, error) {
	...
	return &jobstate.CreateResult{JobItemID: "item-1", Status: pb.JobItemAckStatus_JOB_ITEM_ACK_STATUS_CREATED, Created: true}, nil
}
func (s *orderedStore) MarkEnqueueFailed(context.Context, string, string, string) error { return nil }
