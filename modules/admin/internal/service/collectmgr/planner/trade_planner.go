...
func (d *TradePlanner) GetTargetObjects(ctx context.Context, rule *model.CollectorTaskRules) ([]string, error) {
...
func (d *TradePlanner) BuildTaskParams(ctx context.Context, rule *model.CollectorTaskRules, object string) (string, error) {
	params, err := d.base.ParseCollectParams(rule.CollectParams)
	if err != nil {
		return "{}", err
	}
...
func (d *TradePlanner) GetMatchingNodes(ctx context.Context, rule *model.CollectorTaskRules) ([]*cloudnodemodel.CloudNode, error) {
