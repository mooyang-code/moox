...
func (d *NewsPlanner) GetTargetObjects(ctx context.Context, rule *model.CollectorTaskRules) ([]string, error) {
	return nil, nil
}

// BuildTaskParams 为指定对象构建任务参数
func (d *NewsPlanner) BuildTaskParams(ctx context.Context, rule *model.CollectorTaskRules, object string) (string, error) {
...
func (d *NewsPlanner) GetMatchingNodes(ctx context.Context, rule *model.CollectorTaskRules) ([]*cloudnodemodel.CloudNode, error) {
