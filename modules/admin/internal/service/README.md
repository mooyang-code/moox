...
```bash
cd src/github.com/mooyang-code/moox/modules/admin
go mod tidy
```
...
import (
    ...
    "github.com/mooyang-code/moox/modules/admin/internal/service/admin"
    adminconfig "github.com/mooyang-code/moox/modules/admin/internal/service/admin/config"
)
