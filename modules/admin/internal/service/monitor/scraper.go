...
func (c *MetricsScraper) CollectBatch(ctx context.Context, hosts []*dao.MonitorHost) map[int]*RawMetrics {
	if len(hosts) == 0 {
...
// collect 采集单个主机
func (c *MetricsScraper) collect(ctx context.Context, host *dao.MonitorHost) (*RawMetrics, error) {
