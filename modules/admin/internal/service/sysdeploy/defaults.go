...
const storageMetadataGatewayMethods = "[\"CreateSpace\",\"UpdateSpace\",\"GetSpace\",\"ListSpaces\",\"CreateView\",\"UpdateView\",\"DeleteView\",\"RequestViewRebuild\",\"UpsertViewColumn\",\"ListViewRebuildLogs\",\"CreateDataSource\",\"UpdateDataSource\",\"GetDataSource\",\"ListDataSources\",\"UpsertSubject\",\"CreateDataset\",\"UpdateDataset\",\"DeleteDataset\",\"CreateFieldGroup\",\"UpdateFieldGroup\",\"GetFieldGroup\",\"ListFieldGroups\",\"CreateField\",\"UpdateField\",\"GetField\",\"ListFields\",\"BatchUpdateFields\",\"DeleteFieldGroup\",\"CreateFactor\",\"UpdateFactor\",\"GetFactor\",\"ListFactors\",\"UpsertDatasetColumn\",\"ListDatasetColumns\",\"GetDataNode\",\"ListDataNodes\",\"UpdateDataNode\",\"DeleteDataNode\",\"CheckDatasetActivation\",\"ActivateDataset\",\"RebindDatasetDataNode\",\"RegisterArchiveFile\",\"ListArchiveFiles\"]"
const storageMetadataTagWriteGatewayMethods = "[\"UpsertTag\",\"DeleteTag\",\"AddTagMembers\",\"RemoveTagMembers\",\"SetTagMemberStatus\"]"
const storageMetadataSubjectSyncGatewayMethods = "[\"ApplyTagSnapshot\",\"ReportTagRunFailure\",\"UpdateSubjectAttributes\"]"
const storageMetadataReadTagGatewayMethods = "[\"GetTag\",\"ListTags\",\"ListTagMembers\",\"ResolveSubjects\"]"
const storageMetadataStrategyGatewayMethods = "[\"GetView\",\"ListViews\",\"ListViewColumns\",\"GetDataset\",\"ListDatasets\",\"ListDatasetSubjects\",\"ListSubjects\",\"GetSubject\"]"
const storageMetadataReadGatewayCallers = "[\"admin-gateway\",\"collector\",\"factor\",\"monitor\",\"archive\",\"moox-cli\",\"storage-view\",\"strategy\"]"
const storagePrimaryGatewayMethods = "[\"UpsertFields\",\"ReadFields\",\"ReadRecordRows\",\"DeleteDatasetRows\",\"RestoreDatasetRows\",\"ReportCollectorPeriodCompleted\",\"ReportMergePeriodCompleted\",\"CommitInput\",\"PatchFactor\",\"AppendDatasetSyncPoint\",\"WaitViewSyncPoint\",\"ReportFactorPeriodComputed\",\"GetFactorPeriodComputed\"]"
...
const storagePrimaryGatewayCallers = "[\"admin-gateway\",\"collector\",\"factor\",\"merge\",\"monitor\",\"archive\",\"storage-view\"]"
...
func storagePrimaryExtraConfig() string {
	return fmt.Sprintf(`{"health_url":"http://127.0.0.1:20210/readyz","health_kind":"readiness","monitor_enabled":true,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s,"gateway_routes":[{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":["DeleteSpace"],"gateway_callers":["admin-gateway","moox-cli"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":["ClaimViewIndexBuild","UpdateViewIndexBuild","ActivateViewIndex","FailViewIndexBuild","CreateViewRebuildLog","UpdateViewRebuildLog","UpsertSkippedViewRebuildLog"],"gateway_callers":["storage-view"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":["admin-gateway","moox-cli"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":["collector"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s},{"service_path":"trpc.moox.storage.PrimaryStore","port":20102,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s},{"service_path":"trpc.moox.storage.PrimaryStore","port":20102,"max_body_bytes":33554432,"gateway_methods":["ReadTimeSeriesRows"],"gateway_callers":%s}]}`, storageMetadataGatewayMethods, storageMetadataGatewayCallers, storageMetadataTagWriteGatewayMethods, storageMetadataSubjectSyncGatewayMethods, storageMetadataReadTagGatewayMethods, storageMetadataReadGatewayCallers, storageMetadataStrategyGatewayMethods, storageMetadataReadGatewayCallers, storagePrimaryGatewayMethods, storagePrimaryGatewayCallers, storageTimeSeriesGatewayCallers)
}
