...
func storagePrimaryExtraConfig() string {
	return fmt.Sprintf(`{"health_url":"http://127.0.0.1:20210/readyz","health_kind":"readiness","monitor_enabled":true,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s,"gateway_routes":[{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":["DeleteSpace"],"gateway_callers":["admin-gateway","moox-cli"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":["ClaimViewIndexBuild","UpdateViewIndexBuild","ActivateViewIndex","FailViewIndexBuild","CreateViewRebuildLog","UpdateViewRebuildLog","UpsertSkippedViewRebuildLog"],"gateway_callers":["storage-view"]},{"service_path":"trpc.moox.storage.Metadata","port":20100,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s},{"service_path":"trpc.moox.storage.PrimaryStore","port":20102,"max_body_bytes":33554432,"gateway_methods":%s,"gateway_callers":%s},{"service_path":"trpc.moox.storage.PrimaryStore","port":20102,"max_body_bytes":33554432,"gateway_methods":["ReadTimeSeriesRows"],"gateway_callers":%s}]}`, storageMetadataGatewayMethods, storageMetadataGatewayCallers, storageMetadataStrategyGatewayMethods, storageMetadataReadGatewayCallers, storagePrimaryGatewayMethods, storagePrimaryGatewayCallers, storageTimeSeriesGatewayCallers)
}
