...
var eventBusRoles = []string{"eventbus-internal-admin", "hostagent-publisher", "monitor-hostmetrics-consumer", "storage-eventbus", "cloudnode-eventbus", "factor-eventbus"}
var eventBusKeys = map[string]string{"eventbus-internal-admin": "eventbus_internal_admin", "hostagent-publisher": "eventbus_hostagent_publisher", "monitor-hostmetrics-consumer": "eventbus_monitor_consumer", "storage-eventbus": "eventbus_storage", "cloudnode-eventbus": "eventbus_cloudnode", "factor-eventbus": "eventbus_factor"}
...
func usersYAML(tokens map[string]string) string { // ACLs are deliberately subject-scoped; JetStream API permissions are not granted to publisher roles.
	return fmt.Sprintf("users:\n  - username: eventbus-internal-admin\n    password: %s\n    permissions:\n      publish: {allow: [\"$JS.API.>\", \"$JS.ACK.>\"]}\n      subscribe: {allow: [\"$JS.API.>\", \"$JS.ACK.>\", \"_INBOX.>\"]}\n  - username: hostagent-publisher\n    password: %s\n    permissions:\n      publish: {allow: [\"moox.metrics.host.reported.v1\"]}\n      subscribe: {allow: [\"_INBOX.>\"]}\n  - username: monitor-hostmetrics-consumer\n    password: %s\n    permissions:\n      publish: {allow: [\"moox.dlq.message.rejected.v1\"]}\n      subscribe: {allow: [\"$JS.API.CONSUMER.INFO.MOOX_METRICS.monitor_hostmetrics_ingest_v1\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_METRICS.monitor_hostmetrics_ingest_v1\", \"$JS.ACK.MOOX_METRICS.monitor_hostmetrics_ingest_v1.>\", \"_INBOX.>\"]}\n  - username: storage-eventbus\n    password: %s\n    permissions:\n      publish: {allow: [\"moox.storage.time_series.rows_updated.v1\", \"moox.storage.record.rows_updated.v1\"]}\n      subscribe: {allow: [\"$JS.API.CONSUMER.INFO.MOOX_STORAGE.storage_view_builder_time_series_rows_updated_v1\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_STORAGE.storage_view_builder_time_series_rows_updated_v1\", \"$JS.ACK.MOOX_STORAGE.storage_view_builder_time_series_rows_updated_v1.>\", \"$JS.API.CONSUMER.INFO.MOOX_STORAGE.storage_view_builder_record_rows_updated_v1\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_STORAGE.storage_view_builder_record_rows_updated_v1\", \"$JS.ACK.MOOX_STORAGE.storage_view_builder_record_rows_updated_v1.>\", \"_INBOX.>\"]}\n  - username: cloudnode-eventbus\n    password: %s\n    permissions:\n      publish: {allow: [\"moox.cloudnode.exec.v1.>\"]}\n      subscribe: {allow: [\"$JS.API.>\", \"$JS.ACK.>\", \"_INBOX.>\"]}\n  - username: factor-eventbus\n    password: %s\n    permissions:\n      publish: {allow: []}\n      subscribe: {allow: [\"$JS.API.CONSUMER.INFO.MOOX_STORAGE.factor_calc\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_STORAGE.factor_calc\", \"$JS.ACK.MOOX_STORAGE.factor_calc.>\", \"_INBOX.>\"]}\n", tokens["eventbus-internal-admin"], tokens["hostagent-publisher"], tokens["monitor-hostmetrics-consumer"], tokens["storage-eventbus"], tokens["cloudnode-eventbus"], tokens["factor-eventbus"])
}
