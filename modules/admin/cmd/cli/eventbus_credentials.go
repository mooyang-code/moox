...
func usersYAML(tokens map[string]string) string { // ACLs are deliberately subject-scoped; publisher roles never receive broad JetStream API access.
	return fmt.Sprintf("users:\n"+
		...
		"  - username: storage-eventbus\n    password: %s\n    permissions:\n      publish: {allow: [\"moox.storage.dataset.rows.upserted.v2.>\", \"moox.storage.dataset.period.collected.v1.>\", \"moox.storage.view.source_period.ready.v1.>\", \"moox.storage.dataset.factor_period.computed.v1.>\", \"moox.storage.view.factor_period.ready.v1.>\", \"moox.storage.dataset.sync_point.v1.>\", \"$JS.API.STREAM.NAMES\", \"$JS.API.CONSUMER.INFO.*.storage_view\", \"$JS.API.CONSUMER.CREATE.MOOX_STORAGE.storage_view\", \"$JS.API.CONSUMER.CREATE.MOOX_STORAGE.storage_view.>\", \"$JS.API.CONSUMER.DURABLE.CREATE.MOOX_STORAGE.storage_view\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_STORAGE.storage_view\", \"$JS.ACK.MOOX_STORAGE.storage_view.>\", \"$JS.API.CONSUMER.INFO.*.storage_view_period_v1\", \"$JS.API.CONSUMER.CREATE.MOOX_STORAGE.storage_view_period_v1\", \"$JS.API.CONSUMER.CREATE.MOOX_STORAGE.storage_view_period_v1.>\", \"$JS.API.CONSUMER.DURABLE.CREATE.MOOX_STORAGE.storage_view_period_v1\", \"$JS.API.CONSUMER.MSG.NEXT.MOOX_STORAGE.storage_view_period_v1\", \"$JS.ACK.MOOX_STORAGE.storage_view_period_v1.>\"]}\n      subscribe: {allow: [\"_INBOX.>\"]}\n"+
