...
import (
	...
	// 导入NATS实现以触发init注册
	_ "github.com/mooyang-code/moox/server/internal/service/msghub/consumer/nats"
)

// NewConsumer 创建消费者
func NewConsumer(consumerType msghub.ConsumerType, opts types.ConsumerOptions) (types.Consumer, error) {
