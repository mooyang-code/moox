...
import (
	...
	// 导入NATS实现以触发init注册
	_ "github.com/mooyang-code/moox/server/internal/service/msghub/server/nats"
)

// NewMessageServer 创建消息服务器
func NewMessageServer(serverType msghub.ServerType, opts types.ServerOptions) (types.MessageServer, error) {
