...
import (
	...
	"github.com/mooyang-code/moox/server/internal/service/ssh/crypto/ssh"
	"github.com/mooyang-code/moox/server/internal/service/ssh/sftp"
	"github.com/mooyang-code/moox/server/internal/service/ssh/websocket"
...
func CreateSessionId(c *gin.Context) {
	...
	log.Infof("CreateSessionId: %s", sessionId)
