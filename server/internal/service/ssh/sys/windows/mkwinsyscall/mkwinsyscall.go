...
// ParseFiles parses files listed in sftpfs and extracts all syscall
...
func (src *Source) Generate(w io.Writer) error {
	...
	if *systemDLL {
		...
		case pkgXSysWindows:
		default:
			src.ExternalImport("github.com/mooyang-code/moox/server/internal/service/ssh/sys/windows")
		}
	}
	if packageName != "syscall" {
		src.Import("syscall")
