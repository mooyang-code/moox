...
type CollectorDataTypeConfigHandler struct {
	service collectmgr.DataTypeConfigService
}

// NewCollectorDataTypeConfigHandler 创建采集器数据类型配置处理器
func NewCollectorDataTypeConfigHandler(service collectmgr.DataTypeConfigService) *CollectorDataTypeConfigHandler {
