...
// NewTaskConfigService 创建采集任务配置服务实例
func NewTaskConfigService(taskConfigDAO dao.CollectorTaskConfigDAO,
	nodeDAO cloudnodedao.CloudNodeDAO, getCloudProvider func(string) provider.Client) TaskConfigService {
...
func (s *taskConfigServiceImpl) GetTaskConfigList(ctx context.Context, projectID, datasetID string) ([]*model.CollectorTaskConfig, error) {
...
func (s *taskConfigServiceImpl) GetTaskConfig(ctx context.Context, taskID string) (*model.CollectorTaskConfig, error) {
	if taskID == "" {
...
func (s *taskConfigServiceImpl) CreateTaskConfig(ctx context.Context, config *model.CollectorTaskConfig) error {
	// 验证必填字段
...
func (s *taskConfigServiceImpl) UpdateTaskConfig(ctx context.Context, config *model.CollectorTaskConfig) error {
	if config.TaskID == "" {
...
func (s *taskConfigServiceImpl) RemoveTaskConfig(ctx context.Context, taskID string) error {
	if taskID == "" {
		return fmt.Errorf("task ID is required")
	}
...
func (s *taskConfigServiceImpl) GetEnabledTaskConfigs(ctx context.Context) ([]*model.CollectorTaskConfig, error) {
...
func (s *taskConfigServiceImpl) GetTaskConfigsByType(ctx context.Context, taskType string) ([]*model.CollectorTaskConfig, error) {
	if taskType == "" {
...
func (s *taskConfigServiceImpl) GetTaskConfigsByNode(ctx context.Context, nodeID string) ([]*model.CollectorTaskConfig, error) {
	if nodeID == "" {
...
func (s *taskConfigServiceImpl) BatchUpdateEnabled(ctx context.Context, taskIDs []string, enabled string) error {
	if len(taskIDs) == 0 {
...
func (s *taskConfigServiceImpl) UpdateDispatchResult(ctx context.Context, taskID string, result string) error {
	if taskID == "" {
		return fmt.Errorf("task ID is required")
	}
...
func (s *taskConfigServiceImpl) validateTaskConfig(config *model.CollectorTaskConfig) error {
	if config.ProjectID == "" {
...
func (s *taskConfigServiceImpl) validateAssignmentConfig(ctx context.Context, config *model.CollectorTaskConfig) error {
...
func (s *taskConfigServiceImpl) validateJSONFields(config *model.CollectorTaskConfig) error {
	// 验证AssignedNodes
...
func (s *taskConfigServiceImpl) SyncTaskConfigToNode(ctx context.Context, taskID string, nodeID string) error {
	// 获取任务配置
	...
	invokeReq := &provider.InvokeFunctionRequest{
		...
		EventData:    event,
		InvokeType:   cloudnode.InvokeTypeSync, // 同步调用
	}
