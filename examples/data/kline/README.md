...
| --- | --- | --- | --- | --- | ---: |
| `stock_cn/stock_cn_kline_1d.csv` | `stock_cn/stock_cn_kline` | `1d` | 100 只股票 | 2026-07-02 至 2026-07-16 | 1,100 |
| `stock_cn/stock_cn_kline_1h.csv` | `stock_cn/stock_cn_kline` | `1h` | 100 只股票 | 2026-07-16 完整交易日 | 400 |
