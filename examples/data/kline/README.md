...
| `crypto/binance_spot_kline_1h.csv` | `crypto/dataset_spot_kline_1h` | `1h` | 10 个交易对 | 2026-07-15 完整自然日 | 240 |
| `crypto/binance_perpetual_kline_1h.csv` | `crypto/dataset_perpetual_kline_1h` | `1h` | 10 个交易对 | 2026-07-15 完整自然日 | 240 |
| `crypto/okx_spot_kline_1h.csv` | `crypto/dataset_spot_kline_1h` | `1h` | 10 个交易对 | 2026-07-15 完整自然日 | 240 |
...
`venue:okx`。其余列与 `config/setup/metadata.yaml` 中对应 Dataset 的列定义
