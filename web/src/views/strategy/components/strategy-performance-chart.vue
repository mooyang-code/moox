      ...
      series: [
        {
          ...
          yField: "value",
          seriesField: "metric",
          data: values.map(point => ({ time: point.time, metric: "NAV", value: point.nav }))
        },
        {
          type: "line",
          xField: "time",
          yField: "value",
          seriesField: "metric",
          data: values.map(point => ({ time: point.time, metric: "回撤", value: point.drawdown }))
        }
      ],
