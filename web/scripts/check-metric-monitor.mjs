...
assert(route.includes('path: "/ops/metric-monitor"'), 'metric monitor route is missing');
assert(route.includes('name: "ops-metric-monitor"'), 'metric monitor route name is missing');
assert(menu.includes('"/ops/metric-monitor"') && menu.includes('"ops-metric-monitor"'), 'metric monitor menu entry is missing');
