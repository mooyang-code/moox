...
| 资源 | Subject/用途 | 容量边界 |
| --- | --- | --- |
| `MOOX_STORAGE` | `storage.dataset.rows.upserted` | 72 小时或 2 GiB |
| `MOOX_METRICS` | 两类 metrics 事件 | 24 小时或 512 MiB |
| `MOOX_CLOUDNODE_EXEC` | 云任务 work queue | 72 小时或 512 MiB |
| `MOOX_TRADE` | Strategy 调仓 work queue | 7 天或 512 MiB |
