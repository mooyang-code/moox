...
type CollectorTaskInstance struct {
    ...
    // 已有字段，确认使用
    IsDeleted string     `gorm:"column:c_is_deleted;default:'false'"`
...
switch rule.AssignmentType:
    case "auto":
        ...
        // SQL: WHERE c_supported_collectors LIKE '%"kline"%' AND c_is_deleted != 'true'
...
// SQL: WHERE c_node_id LIKE 'scf-collector-%' AND c_is_deleted != 'true'
...
// SQL: WHERE c_node_id IN (...) AND c_is_deleted != 'true'
...
// SQL: WHERE c_rule_id = ? AND c_is_deleted != 'true'
...
// SQL: UPDATE ... SET c_is_deleted = 'true' WHERE c_rule_id = ? AND c_is_deleted != 'true'
...
// SQL: UPDATE ... SET c_is_deleted = 'true' WHERE c_task_id IN (...)
