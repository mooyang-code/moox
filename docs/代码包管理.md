...
| 上传到 COS | `modules/cloudnode/internal/rpc/package.go` + `internal/repository` | 生成预签名 URL、校验 COS 对象并落库 |
...
- 批量部署云函数节点时，cloudnode 根据节点、代码包和云账户调用 `internal/providers/tencent-scf`。
