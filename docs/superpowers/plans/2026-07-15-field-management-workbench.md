...
- [x] **Step 1: Add tests for enhanced field queries and mutations**
...
- [x] **Step 3: Extend the protobuf contract**
...
- [x] **Step 4: Regenerate protobuf and tRPC code**
...
- [x] **Step 1: Introduce a typed query boundary**
...
- [x] **Step 2: Write SQLite tests first**
...
- [x] **Step 3: Run SQLite tests and verify failure**
...
- [x] **Step 4: Implement safe SQL queries**
...
- [x] **Step 5: Implement transactional mutations**

Validate a maximum of 100 distinct field IDs, target status (`active` or `disabled`), target group existence, and all field ownership before starting the update. Execute a single transaction and return `updated_count`; delete only groups with no children and no fields.

- [x] **Step 6: Wire service and cache layers**
...
- [x] **Step 1: Verify schema invariants**
...
- [x] **Step 2: Verify importer ordering and compatibility**
...
- [x] **Step 3: Verify the quantitative seed end to end**
...
- [x] **Step 5: Dry-run the real YAML**
...
- [x] **Step 6: Commit schema, importer, seed, and metadata documentation**
...
- [x] **Step 1: Add gateway route coverage**
...
- [x] **Step 2: Assert deployment registration**
...
- [x] **Step 2: Run Vitest and verify failure**
...
- [x] **Step 3: Add API types and functions**
...
- [x] **Step 4: Implement pure state helpers**
...
- [x] **Step 5: Run helper tests and commit**
...
- [x] **Step 1: Implement page orchestration**
...
- [x] **Step 2: Implement the two-level directory**
...
- [x] **Step 3: Implement the dense field table and batch bar**
...
- [x] **Step 4: Replace the field modal with a drawer**
...
- [x] **Step 5: Complete field-group management**
...
- [x] **Step 6: Add responsive and state styling**
...
- [x] **Step 3: Exercise the real gateway path**
...
- [x] **Step 4: Import the seed into an empty test metadata database**
...
- [x] **Step 5: Perform browser acceptance**
...
- [x] **Step 6: Dispatch a fresh review agent**
...
- [x] **Step 7: Fix and reverify every accepted finding**
...
- [x] **Step 8: Write verification evidence and commit**
