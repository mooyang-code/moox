...
Storage View records one generic per-series output watermark. Storage does not
identify K-line datasets; Monitor applies K-line semantics only to configured
View identities:
