...
func DefaultCatalog() (*Catalog, error) {
	return NewCatalog(
		Manifest{MarketID: "crypto", InstrumentType: "spot", DatasetID: "dataset_binance_spot_kline_1m", CalendarID: "utc_crypto", Timezone: "UTC", Frequencies: []string{"1m", "1h", "1d", "1w"}, Sources: []SourceRef{{ProviderID: "binance", SourceID: "spot_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1h", "1d", "1w"}, Status: SourceEnabled}}, Enabled: true},
		Manifest{MarketID: "crypto", InstrumentType: "swap", DatasetID: "dataset_binance_swap_kline_1m", CalendarID: "utc_crypto", Timezone: "UTC", Frequencies: []string{"1m", "1h", "1d", "1w"}, Sources: []SourceRef{{ProviderID: "binance", SourceID: "spot_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1h", "1d", "1w"}, Status: SourceEnabled}}, Enabled: true},
		Manifest{MarketID: "stockcn", InstrumentType: "equity", DatasetID: "dataset_stockcn_equity_kline", CalendarID: "cn_stock", Timezone: "Asia/Shanghai", Frequencies: []string{"1m", "1d", "1w", "1M"}, Sources: []SourceRef{{ProviderID: "tdx", SourceID: "normal_7709", ProtocolVariant: "tdx_normal", Transport: "tcp", Port: 7709, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceEnabled}, {ProviderID: "eastmoney", SourceID: "stockcn_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}, {ProviderID: "sina", SourceID: "stockcn_minute_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}, {ProviderID: "tencent", SourceID: "stockcn_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}}, Enabled: true},
		Manifest{MarketID: "stockcn", InstrumentType: "index", DatasetID: "dataset_stockcn_index_kline", CalendarID: "cn_stock", Timezone: "Asia/Shanghai", Frequencies: []string{"1m", "1d", "1w", "1M"}, Sources: []SourceRef{{ProviderID: "tdx", SourceID: "normal_7709", ProtocolVariant: "tdx_normal", Transport: "tcp", Port: 7709, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceCatalogOnly}, {ProviderID: "eastmoney", SourceID: "index_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceCatalogOnly}}, Enabled: false},
		Manifest{MarketID: "stockcn", InstrumentType: "convertible_bond", DatasetID: "dataset_stockcn_bond_kline", CalendarID: "cn_stock", Timezone: "Asia/Shanghai", Frequencies: []string{"1m", "1d"}, Sources: []SourceRef{{ProviderID: "tdx", SourceID: "normal_7709", ProtocolVariant: "tdx_normal", Transport: "tcp", Port: 7709, Frequencies: []string{"1m", "1d"}, Status: SourceCatalogOnly}, {ProviderID: "eastmoney", SourceID: "convertible_bond_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1d"}, Status: SourceCatalogOnly}}, Enabled: false},
		Manifest{MarketID: "stockhk", InstrumentType: "equity", DatasetID: "dataset_stockhk_equity_kline", Timezone: "Asia/Hong_Kong", Frequencies: []string{"1m", "1d", "1w", "1M"}, Sources: []SourceRef{{ProviderID: "eastmoney", SourceID: "stockhk_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceCatalogOnly}}, Enabled: false},
		Manifest{MarketID: "stockus", InstrumentType: "equity", DatasetID: "dataset_stockus_equity_kline", Timezone: "America/New_York", Frequencies: []string{"1m", "1d", "1w", "1M"}, Sources: []SourceRef{{ProviderID: "eastmoney", SourceID: "stockus_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceCatalogOnly}}, Enabled: false},
	)
}
