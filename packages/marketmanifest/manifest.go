...
func DefaultCatalog() (*Catalog, error) {
	return NewCatalog(
		...
		Manifest{MarketID: "stock_cn", InstrumentType: "equity", DatasetID: "stock_cn_kline", CalendarID: "cn_stock", Timezone: "Asia/Shanghai", Frequencies: []string{"1m", "1d", "1w", "1M"}, Sources: []SourceRef{{ProviderID: "tdx", SourceID: "normal_7709", ProtocolVariant: "tdx_normal", Transport: "tcp", Port: 7709, Frequencies: []string{"1m", "1d", "1w", "1M"}, Status: SourceEnabled}, {ProviderID: "eastmoney", SourceID: "stock_cn_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}, {ProviderID: "sina", SourceID: "stock_cn_minute_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}, {ProviderID: "tencent", SourceID: "stock_cn_http", ProtocolVariant: "http", Transport: "https", Port: 443, Frequencies: []string{"1m"}, Status: SourceEnabled}}, Enabled: true},
