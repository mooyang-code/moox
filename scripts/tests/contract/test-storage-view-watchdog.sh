...
grep -q 'MOOX_STORAGE_VIEW_DELIVER_POLICY="${MOOX_STORAGE_VIEW_DELIVER_POLICY:-new}"' "${WATCHDOG}"
grep -q '^Environment=MOOX_STORAGE_VIEW_DELIVER_POLICY=new$' "${ROOT}/deploy/systemd/system/moox-storage-view-watchdog.service"
