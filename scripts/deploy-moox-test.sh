...
assert_file "${DEPLOY_DIR}/admin/config/app.yaml"
assert_file "${DEPLOY_DIR}/admin/config/gateway.yaml"
...
assert_contains "${DEPLOY_DIR}/admin/config/app.yaml" "path: ../data/moox.db"
assert_contains "${DEPLOY_DIR}/admin/config/app.yaml" "output_path: ../logs/admin/moox.log"
assert_contains "${DEPLOY_DIR}/admin/config/gateway.yaml" "dbname: \"../data/moox.db\""
assert_contains "${DEPLOY_DIR}/admin/config/gateway.yaml" "data_dir: \"../data/badger\""
assert_contains "${DEPLOY_DIR}/admin/config/trpc_go.yaml" "log_path: ../logs/admin"
