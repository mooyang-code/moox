...
usage() {
  cat <<'EOF'
Usage: scripts/publish-release-binaries.sh [options]
...
Examples:
  ./scripts/publish-release-binaries.sh --target user@host --dir /data/moox/prod
  ./scripts/publish-release-binaries.sh --artifact release/moox-binaries-v1-linux-amd64 \
