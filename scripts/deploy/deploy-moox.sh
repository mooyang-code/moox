...
# Keep the generated restart script self-contained. The deploy-time shell
# computes this array for the initial process, but start.sh must rebuild it
# after a reboot or an explicit service restart as well.
