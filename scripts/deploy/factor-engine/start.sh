...
export MOOX_METRICS_EVENTBUS_CREDENTIAL_FILE="${MOOX_METRICS_EVENTBUS_CREDENTIAL_FILE:-${EVENTBUS_CREDENTIAL_FILE}}"
export MOOX_METRICS_EVENTBUS_URL="${MOOX_METRICS_EVENTBUS_URL:-${MOOX_EVENTBUS_NATS_URL}}"
export MOOX_EVENTBUS_NATS_TLS_CA_FILE="${EVENTBUS_CA_FILE}"
export MOOX_EVENTBUS_NATS_URL
export MOOX_INSTANCE_ID="${MOOX_INSTANCE_ID:-moox_factor_engine}"
export MOOX_NODE_ID="${MOOX_NODE_ID:-local}"
