...
(cd modules/collector && go test ./internal/sources/binance -run TestKlineCollectorLiveAlsoWritesOnlyClosedKlines -count=1)
(cd modules/storage && CGO_ENABLED=1 go test ./internal/service/datanode/... -count=1)
